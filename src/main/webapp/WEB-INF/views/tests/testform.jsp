		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<form class="user" action="/patients/new" method="post">
								
								<div class="form-group">
									<input type="text" class="form-control form-control-user"
										id="" placeholder="Label" name="label">
								</div>
								<div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="number" name="duration" min="30" class="form-control form-control-user" id=""
                                            placeholder="Duration in minutes">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="number" min="1" name="day" class="form-control form-control-user" id=""
                                            placeholder="How many days to get results">
                                    </div>
                                </div>
